...
docker buildx build --platform linux/arm/v7 --tag matteoserina/dispensapp-be .
docker tag matteoserina/dispensapp-be:latest matteoserina/dispensapp-be:v$ver
...
docker push matteoserina/dispensapp-be:v$ver
docker push matteoserina/dispensapp-be:latest
